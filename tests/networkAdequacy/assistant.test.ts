...
/** NA-2 — interactive assistant (deterministic intent engine). */
const net = loadMockNetwork();

describe('Intent parsing', () => {
  it('maps "Maria’s state" to SD and detects specialty/LOB', () => {
    const i = parseIntent('show the Medicaid pediatric baseline for Maria’s state', net);
  ...
  it('maps behavioral → Mental Health and peds → Pediatrics', () => {
