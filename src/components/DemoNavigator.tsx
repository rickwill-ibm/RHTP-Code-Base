...
const DEMO_PERSONAS: DemoPersona[] = [
  ...
  },
  {
    ...
    initials: 'AM',
    steps: [
      { stepNum: 34, route: '/uhg-orchestrate/fragmentation-split-system-view', label: 'One Enterprise · Five Entities', storyBeat: 'Why fragmentation breaks Maria\'s care across UHC, Optum, Surest, UMR, Rally', activePatient: 'MARIA_SD_001' },
      { stepNum: 35, route: '/uhg-orchestrate/cdp-assembly-split', label: 'CDP Assembly', storyBeat: '52 data dimensions unified — Maria\'s consent-governed citizen profile assembled', activePatient: 'MARIA_SD_001' },
      { stepNum: 36, route: '/whole-person-care-summary', label: 'Whole Person Care View', storyBeat: 'All 52 dimensions of Maria\'s life visible in one knowledge graph — 4 roles, 14 streams, 4 consent layers', activePatient: 'MARIA_SD_001' },
      { stepNum: 37, route: '/uhg-orchestrate/consumer-360', label: 'Journey-Aware Context', storyBeat: 'Maria\'s live episode window — milestones, expected vs. unexpected signals', activePatient: 'MARIA_SD_001' },
      { stepNum: 38, route: '/uhg-orchestrate/whole-person-care', label: 'Whole Person Care Intelligence', storyBeat: 'SDOH amplifiers: Financial 82, Caregiver Burden 88, Transport blocker → care plan mods', activePatient: 'MARIA_SD_001' },
      { stepNum: 39, route: '/uhg-orchestrate/signal-disposition-engine', label: 'Signal Disposition Engine', storyBeat: 'Live signals from Maria\'s care events — agents dispatched in real-time', activePatient: 'MARIA_SD_001' },
      { stepNum: 40, route: '/uhg-orchestrate/controller-agentic-super-orchestration-centerpiece', label: 'Agentic Super Orchestration', storyBeat: 'Controller agent coordinates CHW + Clinical + BH + Social agents for Maria', activePatient: 'MARIA_SD_001' },
      { stepNum: 41, route: '/uhg-orchestrate/agent-library', label: 'Agentic Marketplace', storyBeat: 'Agents activated for Maria\'s case — roles, triggers, outcomes', activePatient: 'MARIA_SD_001' },
      { stepNum: 42, route: '/uhg-orchestrate/family-sofia', label: 'Family Thread — Sofia', storyBeat: 'Maria\'s dependent Sofia — pediatric gaps surfaced and orchestrated in the household loop', activePatient: 'MARIA_SD_001' },
      { stepNum: 43, route: '/uhg-orchestrate/caregiver-elena', label: 'Caregiver Intelligence — Elena', storyBeat: 'Maria as caregiver — Elena\'s INR, polypharmacy, Martin Pharmacy refill sync', activePatient: 'MARIA_SD_001' },
      { stepNum: 44, route: '/uhg-orchestrate/portfolio-scale', label: 'Live Population Filter', storyBeat: 'Maria\'s profile at population scale — cohort, risk tier, at-scale impact', activePatient: 'MARIA_SD_001' },
      { stepNum: 45, route: '/uhg-orchestrate/agent-impact-dashboard', label: 'Agent Impact Dashboard', storyBeat: 'What agents achieved for Maria — A1C, appointments, SDOH tasks, cost avoidance', activePatient: 'MARIA_SD_001' },
      { stepNum: 46, route: '/uhg-orchestrate/reporting-dashboard', label: 'Agent Impact — Reporting', storyBeat: 'Closed loop — Maria\'s case as proof-point for enterprise agentic ROI', activePatient: 'MARIA_SD_001' },
    ],
  },
  {
    id: 'watsonx-demo',
    ...
    initials: 'WX',
    steps: [
      { stepNum: 47, route: '/uhg-orchestrate/cdp-assembly-split', label: '1 · CDP Assembly', storyBeat: '4 systems, 4 records → one unified identity — knowledge graph assembly (0:50)', activePatient: 'MARIA_SD_001' },
      { stepNum: 48, route: '/whole-person-care-summary', label: '2 · Whole Person Care View', storyBeat: 'Knowledge graph — 52 dimensions of Maria\'s life; caregiver burden is the root cause (1:10)', activePatient: 'MARIA_SD_001' },
      { stepNum: 49, route: '/patient-detail', label: '3 · Patient Detail — 360°', storyBeat: 'Whole Person Care Plan tab — every dimension of her life (1:30)', activePatient: 'MARIA_SD_001' },
      { stepNum: 50, route: '/md-smart-launch', label: '4 · MD Smart Launch — Care Plan', storyBeat: 'Cerner SmartApp — tiered care plan, respite first → click Approve (1:55)', activePatient: 'MARIA_SD_001' },
      { stepNum: 51, route: '/cbo-directory', label: '5 · CBO Directory', storyBeat: 'Community referrals — digital, tracked, closed-loop (2:10)', activePatient: 'MARIA_SD_001' },
      { stepNum: 52, route: '/care-gap-closure-verification', label: '6 · Gap Closure Verification', storyBeat: 'All 3 gaps CLOSED — evidence chain verified (2:25)', activePatient: 'MARIA_SD_001' },
      { stepNum: 53, route: '/executive-outcomes-dashboard', label: '7 · Executive Outcomes', storyBeat: '6,842 gaps closed · ED ↓18% · $1.1M reinvested — close here (2:45)', activePatient: 'MARIA_SD_001' },
      { stepNum: 54, route: '/md-smart-launch', label: '8 · MD SmartApp — Encore', storyBeat: 'Cerner PowerChart view — FHIR-native, write-back orders (3:00)', activePatient: 'MARIA_SD_001' },
    ],
  },
];
