        ...
        <div className="px-5 py-4">
          ...
          <div className="mt-4 pt-4 border-t border-[#2a3550]">
            <p className="text-2xs text-carbon-gray-50 text-center">
              Encounter <span className="font-mono text-carbon-gray-30">{launchContext.encounterId}</span> updated in Cerner · MD may close this panel and resume encounter in UHG Controller
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="bg-[#0f1624] border border-[#2a3550]">
      ...
      <div className="p-5">
        ...
        >
          ...
          Return to Cerner / UHG Controller
        </button>
