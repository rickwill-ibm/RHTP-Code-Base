...
function buildSignalEvaluations(firstName: string, org: string, topGapName: string, episode: string, day: number, contract: string, sdohSummary: string): SignalEvaluation[] {
  ...
  },
  {
    ...
    competingSignals: 'Elevates urgency — postpartum episode context amplifies medication safety risk',
    ...
    rationale: [
      ...
      'Duplicate BP med therapy creates active safety risk — A1C instability during postpartum recovery is a readmission predictor',
