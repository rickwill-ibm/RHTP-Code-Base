    ...
    <main className="mx-auto max-w-6xl space-y-6 p-6">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-600">
          Measure, monitor, and <strong>validate</strong> provider network adequacy by specialty ×
          county × line of business against CMS time-distance, in-network, wait-time, and ratio
