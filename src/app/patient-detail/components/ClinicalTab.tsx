...
const FALLBACK_CONDITIONS: ConditionEntry[] = [
...
const FALLBACK_MEDICATIONS: MedicationEntry[] = [
...
const FALLBACK_ORDERS: OrderEntry[] = [
            ...
            <div key={o.key} className="flex items-center justify-between px-4 py-3 bg-carbon-gray-10 border border-carbon-gray-20">
              ...
              <div className="text-right">
                <p className={`text-xs font-mono font-semibold ${
                  o.flag === 'Critical' ? 'text-[#da1e28]'
                  : o.flag === 'High' ? 'text-[#b45309]'
                  : o.flag === 'Low' ? 'text-[#0043ce]'
                  : 'text-carbon-gray-70'
                }`}>
                  {o.result}
                </p>
