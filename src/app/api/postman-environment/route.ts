...
export async function GET(req: NextRequest) {
  ...
  const env = {
    ...
    values: [
      ...
      { key: 'wso2AuthorizeUrl', value: cfg.wso2AuthorizeUrl,       type: 'default', enabled: mode === 'production' },
      { key: 'wso2TokenUrl',     value: cfg.wso2TokenUrl,           type: 'default', enabled: mode === 'production' },
      { key: 'wso2ClientId',     value: cfg.wso2ClientId,           type: 'default', enabled: mode === 'production' },
    ],
  };
