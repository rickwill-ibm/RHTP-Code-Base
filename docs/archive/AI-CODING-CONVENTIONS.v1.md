> **SUPERSEDED (2026-08-21):** governing conventions are now `/AI-CODING-CONVENTIONS.md` (v2).
> This v1 file is retained for history and as the human-readable companion to the
> quality-baseline ratchet. Do not cite it as current guidance.
